...
@NoArgsConstructor
public class RAGDocumento extends JsonObject implements Serializable {
    ...
    @JsonProperty("semanticProximity")
	private double semanticProximity;
    ...
    public RAGDocumento(String id, String title) {
		this.id = id;
		this.title = title;
	}
